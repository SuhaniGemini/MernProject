...
const Newproduct = () => {
  ...
  const handleSubmit = async(e)=>{
    ...
    const {name,image,category,dietary,price} = data

    if(name && image && category && dietary && price){
  ...
  return (
    <div className="p-4">
       <form className='m-auto w-full max-w-md  shadow flex flex-col p-3 bg-white' onSubmit={handleSubmit}>
        ...
        <input type={"text"}  name="dietary" className='bg-slate-200 p-1 my-1' onChange={handleOnChange} value={data.dietary}/>
